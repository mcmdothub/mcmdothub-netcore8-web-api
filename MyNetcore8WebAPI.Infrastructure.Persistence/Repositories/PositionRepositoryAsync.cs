...
using MyNetcore8WebAPI.Application.Features.Positions.Queries.GetPositions;
using MyNetcore8WebAPI.Application.Interfaces;
using MyNetcore8WebAPI.Application.Interfaces.Repositories;
using MyNetcore8WebAPI.Application.Parameters;
using MyNetcore8WebAPI.Domain.Entities;
using MyNetcore8WebAPI.Infrastructure.Persistence.Contexts;
using MyNetcore8WebAPI.Infrastructure.Persistence.Repository;
